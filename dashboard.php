...
<!-- Mirrored from bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/index4.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jul 2024 06:15:46 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8" />
      ...
      <div><!-- ---------------------------------- -->
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
          ...
          <div class="user-profile position-relative" style="background: url(https://bootstrapdemos.wrappixel.com/materialpro/dist/assets/images/backgrounds/user-info.jpg) no-repeat;">
            ...
            <div class="profile-text hide-menu pt-1 dropdown">
              ...
              <div class="dropdown-menu animated flipInY" aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item d-flex gap-2" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/page-user-profile.html">
                  <i data-feather="user" class="feather-sm text-info "></i>
                  My Profile
                </a>
                <a class="dropdown-item d-flex gap-2" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/app-notes.html">
                  <i data-feather="credit-card" class="feather-sm text-info "></i>
                  My Notes
                </a>
                <a class="dropdown-item d-flex gap-2" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/app-email.html">
                  <i data-feather="mail" class="feather-sm text-success "></i>
                  Inbox
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item d-flex gap-2" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/page-account-settings.html">
                  <i data-feather="settings" class="feather-sm text-warning "></i>
                  Account Setting
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item d-flex gap-2" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/authentication-login.html">
                  <i data-feather="log-out" class="feather-sm text-danger "></i>
                  Logout
                </a>
                <div class="dropdown-divider"></div>
                <div class="px-3 py-2">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/page-user-profile.html" class="btn d-block w-100 btn-info rounded-pill">View Profile</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/index2.html">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="index4.html">
                <iconify-icon icon="solar:buildings-2-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Campaign</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/index5.html">
                <iconify-icon icon="solar:basketball-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Modern</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/index6.html">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/app-calendar.html">
                <iconify-icon icon="solar:calendar-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Calendar</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/app-kanban.html">
                <iconify-icon icon="solar:notes-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Kanban</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/app-chat.html">
                <iconify-icon icon="solar:chat-line-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Chat</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/app-email.html">
                <iconify-icon icon="solar:letter-unread-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Email</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/app-notes.html">
                <iconify-icon icon="solar:palette-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Notes</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/app-contact.html">
                <iconify-icon icon="solar:bedside-table-2-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Contact Table</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/app-contact2.html">
                <iconify-icon icon="solar:list-check-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Contact List</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/app-invoice.html">
                <iconify-icon icon="solar:bill-list-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Invoice</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/page-user-profile.html">
                <iconify-icon icon="solar:user-circle-linear" class="aside-icon"></iconify-icon>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/blog-posts.html" class="sidebar-link sublink">
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/blog-detail.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                <iconify-icon icon="solar:cart-2-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Ecommerce</span>
              </a>
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/eco-shop.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/eco-shop-detail.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                    <span class="hide-menu">Details</span>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/eco-product-list.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/eco-checkout.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/eco-add-product.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/eco-edit-product.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/page-pricing.html">
                <iconify-icon icon="solar:dollar-minimalistic-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Pricing</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/page-faq.html">
                <iconify-icon icon="solar:question-circle-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">FAQ</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/page-account-settings.html">
                <iconify-icon icon="solar:user-circle-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Account Settings</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/landingpage/index.html">
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/widgets-cards.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/widgets-banners.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/widgets-charts.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/widgets-feeds.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                    <span class="hide-menu">Widgets Feeds</span>
                  </a>
                </li>
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/widgets-apps.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                    <span class="hide-menu">Widgets Apps</span>
                  </a>
                </li>
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/widgets-data.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                    <span class="hide-menu">Widgets Data</span>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-accordian.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-badge.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-buttons.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-dropdowns.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-modals.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-tab.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-tooltip-popover.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-notification.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-progressbar.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-pagination.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-typography.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-bootstrap-ui.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-breadcrumb.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-offcanvas.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-lists.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-grid.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-carousel.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-scrollspy.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-spinner.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-link.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-cards.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-card-customs.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-card-weather.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/ui-card-draggable.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/component-sweetalert.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/component-nestable.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/component-noui-slider.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/component-rating.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/component-toastr.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-inputs.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-input-groups.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                    <span class="hide-menu">Inputs Groups</span>
                  </a>
                </li>
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-input-grid.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-checkbox-radio.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                    <span class="hide-menu">Checkbox Radio</span>
                  </a>
                </li>
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-bootstrap-switch.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-select2.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                <iconify-icon icon="solar:object-scan-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Form Addons</span>
              </a>
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-dropzone.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-mask.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-typeahead.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                    <span class="hide-menu">Form Typeahead</span>
                  </a>
                </li>
              </ul>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                <iconify-icon icon="solar:shield-warning-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Form Validation</span>
              </a>
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-bootstrap-validation.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-custom-validation.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                <iconify-icon icon="solar:waterdrop-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Form Pickers</span>
              </a>
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-picker-colorpicker.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-picker-bootstrap-rangepicker.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-picker-bootstrap-datepicker.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-picker-material-datepicker.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-editor-quill.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                    <span class="hide-menu">Editor Quill</span>
                  </a>
                </li>
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-editor-tinymce.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-basic.html">
                <iconify-icon icon="solar:file-text-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Basic Form</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-vertical.html">
                <iconify-icon icon="solar:file-favourite-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Form Vertical</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-horizontal.html">
                <iconify-icon icon="solar:file-check-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Form Horizontal</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-actions.html">
                <iconify-icon icon="solar:file-smile-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Form Actions</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-row-separator.html">
                <iconify-icon icon="solar:file-right-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Row Separator</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-bordered.html">
                <iconify-icon icon="solar:file-left-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Form Bordered</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-detail.html">
                <iconify-icon icon="solar:checklist-minimalistic-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Form Detail</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-striped-row.html">
                <iconify-icon icon="solar:archive-minimalistic-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Striped Rows</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-floating-input.html">
                <iconify-icon icon="solar:document-add-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Form Floating Input</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-wizard.html">
                <iconify-icon icon="solar:download-twice-square-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Form Wizard</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/form-repeater.html">
                <iconify-icon icon="solar:repeat-linear" class="aside-icon"></iconify-icon>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                <iconify-icon icon="solar:window-frame-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Bootstrap Table</span>
              </a>
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/table-basic.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/table-dark-basic.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/table-sizing.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/table-layout-coloured.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/table-datatable-basic.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/table-datatable-api.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/table-datatable-advanced.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                <iconify-icon icon="solar:pie-chart-2-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Apex Charts</span>
              </a>
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/chart-apex-line.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/chart-apex-area.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/chart-apex-bar.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/chart-apex-pie.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/chart-apex-radial.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/chart-apex-radar.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/pages-animation.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/pages-search-result.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/pages-gallery.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/pages-treeview.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/pages-block-ui.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/pages-session-timeout.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/icon-tabler.html">
                <iconify-icon icon="solar:ghost-smile-linear" class="aside-icon"></iconify-icon>
                <span class="hide-menu">Tabler Icon</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/icon-solar.html">
                <iconify-icon icon="solar:sticker-smile-circle-2-linear" class="aside-icon"></iconify-icon>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/authentication-error.html">
                <iconify-icon icon="solar:shield-warning-linear" class="aside-icon"></iconify-icon>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/authentication-login.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/authentication-login2.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/authentication-register.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/authentication-register2.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/authentication-forgot-password.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/authentication-forgot-password2.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/authentication-two-steps.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
                ...
                <li class="sidebar-item">
                  <a href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/authentication-two-steps2.html" class="sidebar-link sublink">
                    <div class="round-16 d-flex align-items-center justify-content-center">
                      <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                    </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/minisidebar/authentication-maintenance.html">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="https://bootstrapdemos.wrappixel.com/materialpro/dist/docs/index.html">
                <iconify-icon icon="solar:shield-warning-linear" class="aside-icon"></iconify-icon>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                <iconify-icon icon="solar:layers-minimalistic-line-duotone" class="aside-icon"></iconify-icon>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between" href="#chip" aria-expanded="false">
                ...
                <div class="hide-menu">
                  <span class="badge bg-secondary rounded-circle ms-auto px-2 py-1">9</span>
                </div>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between" href="#outlined" aria-expanded="false">
                ...
                <span class="hide-menu badge  border border-secondary text-secondary fw-medium fs-2 py-1 px-2">Outline</span>
              </a>
            </li>
            <li class="sidebar-item">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-lg-8">
              <div class="card">
                <div class="card-body">
                  ...
                  <div id="visitfromworld" class="w-100 h-400"></div>
                </div>
              </div>
            </div>
            <!-- Browser Stats -->
                ...
                <div class="card-body">
                  ...
                  <table class="table mt-3 table-borderless v-middle">
                    <tbody>
                      <tr>
                        <td class="ps-0 w35">
                          <img src="https://bootstrapdemos.wrappixel.com/materialpro/dist/assets/images/browser/chrome-logo.svg" class="img-fluid" alt="logo">
                        </td>
                      ...
                      <tr>
                        <td class="ps-0">
                          <img src="https://bootstrapdemos.wrappixel.com/materialpro/dist/assets/images/browser/firefox-logo.svg" class="img-fluid" alt="logo">
                        </td>
                      ...
                      <tr>
                        <td class="ps-0">
                          <img src="https://bootstrapdemos.wrappixel.com/materialpro/dist/assets/images/browser/safari-logo.svg" class="img-fluid" alt="logo">
                        </td>
                      ...
                      <tr>
                        <td class="ps-0">
                          <img src="https://bootstrapdemos.wrappixel.com/materialpro/dist/assets/images/browser/internet-logo.png" class="img-fluid" alt="logo">
                        </td>
                      ...
                      <tr>
                        <td class="ps-0">
                          <img src="https://bootstrapdemos.wrappixel.com/materialpro/dist/assets/images/browser/opera-logo.svg" class="img-fluid" alt="logo">
                        </td>
                      ...
                      <tr>
                        <td class="ps-0">
                          <img src="https://bootstrapdemos.wrappixel.com/materialpro/dist/assets/images/browser/edge-logo.svg" class="img-fluid" alt="logo">
                        </td>
                      ...
                      <tr>
                        <td class="ps-0">
                          <img src="https://bootstrapdemos.wrappixel.com/materialpro/dist/assets/images/browser/netscape-logo.png" alt="logo" />
                        </td>
            ...
            <div class="col-lg-8">
              <div class="card">
                <div class="card-body">
                  <div class="d-md-flex justify-content-between no-block align-items-center">
                    <h4 class="card-title">Total Revenue</h4>
                    <ul class="d-flex align-items-center gap-3 mb-0">
                      <li class="d-flex">
                        <div class="text-primary d-flex align-items-center gap-2 fs-3">
                          <iconify-icon icon="ri:circle-fill" class="fs-2 text-danger"></iconify-icon>2022
                        </div>
                      </li>
                      <li class="d-flex ">
                        <div class="text-secondary d-flex align-items-center gap-2 fs-3">
                          <iconify-icon icon="ri:circle-fill" class="fs-2 text-secondary"></iconify-icon>2023
                        </div>
                      </li>
                      <li class="d-flex ">
                        <div class="text-secondary d-flex align-items-center gap-2 fs-3">
                          <iconify-icon icon="ri:circle-fill" class="fs-2 text-primary"></iconify-icon>2024
                        </div>
                      </li>
                    </ul>
                  </div>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="row mt-4">
                        <div class="col-7">
                          <span class="display-6 fw-normal text-primary">$3528</span>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="row mt-4">
                        <div class="col-7">
                          <span class="display-6 fw-normal text-success">$4316</span>
                          <h6 class="text-muted">10% Increased</h6>
                          <h5>(150-165 Sales)</h5>
                        </div>
                        <div class="col-5">
