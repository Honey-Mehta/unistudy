...
<div class="form-group">
    ...
    <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Postal Code" name="dob">
  </div>
 ...
 <div class="form-group">
                 ...
                 <label>Marriage Certificate</label>
                      ...
                      <input type="file" name="marriage_certificate">
            </div>
...
<div class="form-group">
                ...
                <input type="file" name="college_transcript">
            </div>
...
<div class="form-group">
                ...
                <input type="file" name="college_diploma">
            </div>
...
<div class="form-group">
                ...
                <input type="file"  name="highschool_transcript">
            </div>
...
<div class="form-group">
                ...
                <input type="file"  name="highschool_diploma">
            </div>
...
<div class="form-group">
                ...
                <input type="file"  name="medium_of_instruction">
            </div>
...
<div class="container-fluid" style="background-color:#F3E6BC; width:100%; height:200px;">
  ...
  <script>
    $(document).ready(function() {
      $("#msform").on("submit", function(event) {
        ...
        $.ajax({
          url: "admin/php/submitdocs_backend.php",
          method: "POST",
          data: formData,
          contentType: false,
          processData: false,
