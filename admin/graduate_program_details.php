...
<nav class="navbar navbar-expand-sm bg-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#features">Admission Requirements</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#location">Similar Programs</a>
      </li>
...
<div class="container-fluid mt-5">
   <div class="row">
      <div class="col-lg-8">
    <h4 id="about" >Program Summary</h4>
...
<div class="row">
<div class="col-lg-8">
<h4 id="features">Admission Requirements</h4>
...
<div class="container-fluid mt-5 bg-primary" style="height:200px;">
   <div class="row">
      <div class="col-lg-8">
    <h4 id="location" >Location</h4>
   
     <p>Location Map is required</p>
