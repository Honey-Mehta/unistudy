...
if (isset($_GET['delete_id'])) {
    ...
    $sqlDELETE = "DELETE FROM `acadmic_intakes` WHERE `id`='$delete_id'";
    ...
    if (mysqli_query($conn, $sqlDELETE)) {
        ...
        <body>
            <script>
                Swal.fire({
                    title: 'Deleted!',
                    text: 'Acadmic intakes has been deleted.',
                    icon: 'success',
                    timer: 1000,
        ...
        <body>
            <script>
                Swal.fire({
                    title: 'Error!',
                    text: 'Failed to delete Acadmic intakes.',
                    icon: 'error',
                    timer: 1000,
                    showConfirmButton: false
                }).then(function() {
   ...
   <?php include('sidebar.php'); ?>
    ...
    <!--  Search Bar -->
      ...
      <div class="container-fluid" style="margin-top:100px; ">
         ...
         <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" style="width:200px; height:50px; font-size:20px;"><i class="fa fa-plus mr-4" ></i> Add Intakes </button>
           <div class="modal fade" id="myModal" >
				     <div class="modal-dialog" >
					    <div class="modal-content">
						<!-- Modal Header -->
						     <div class="modal-header">
						     	<h4 class="modal-title">Add New Intakes</h4>
                  ...
                  <form id="insertForm" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<div class="row">
									<div class="col-sm-12">
											<label for="name" style="float:left;">Year:</label>
											<input type="text" class="form-control"  name="intake_year" required id="year">
										</div>

										<div class="col-sm-12">
                                        <label for="sel1" class="form-label">Success Score:</label>
                                        <input type="text" class="form-control"  name="success_score" required id="success_score">

										</div>

                                          <div class="col-sm-12">
                                        <label for="sel1" class="form-label">Intake Status:</label>
                                          <select name="intake_status" class="form-control" id="intake_status">
                                        ...
                                        <div class="col-sm-12">
                                        <label for="sel1" class="form-label">Submission Deadline:</label>
                                        <input type="date" class="form-control"  name="submission_deadline" id="submission_deadline" required id="submission_deadline">
    ...
    <button type="submit" class="btn btn-primary" style="margin-right: 10px;" id="submit_intake">Submit</button>
    ...
    <table class="table">
        <thead>
            <tr >
                <th scope="col" style="min-width:50px;">#</th>
                 <th scope="col" style="min-width:150px;">Year</th>
                <th scope="col" style="min-width:150px;">Success Score</th>
                <th scope="col" style="min-width:150px;">Intake Status</th>
                   <th scope="col" style="min-width:150px;">Submission Deadliine</th>
        ...
        <tbody>
         ...
         $records_per_page = isset($_GET['items_per_page']) ? (int)$_GET['items_per_page'] : 10; // Default to 10 if not set
            ...
            $total_records_query = "SELECT COUNT(*) FROM `acadmic_intakes`";
            $total_records_result = mysqli_query($conn, $total_records_query);
            $total_records_row = mysqli_fetch_array($total_records_result);
            $total_records = $total_records_row[0];

            // Fetch the records for the current page
            $sqllogistic = mysqli_query($conn, "SELECT * FROM `acadmic_intakes` ORDER BY id DESC LIMIT $records_per_page OFFSET $offset");
            ...
            <tr>
                ...
                <td scope="row"><?php echo $show['year']; ?></td>
                <td><?php echo $show['success_score'];?></td>
    <td><?php echo $show['intake_status'];?></td>
      <td><?php echo $show['submission_deadline'];?></td>
    

                <td>
                <div class="button-container">
                   <a href="edit_intakes.php?edit=<?php echo $show['id']; ?>" class="btn btn-primary btn-lg Edit" target="_blank">Edit</a>
...
<div class="dark-transparent sidebartoggler"></div>
 ...
 <script>
    function confirmDelete(id) {
        Swal.fire({
            title: "Are you sure?",
            text: "Once deleted, you will not be able to recover this Acadmic Intakes!",
            icon: "warning",
...
$(document).ready(function(){
 ...
 $("#submit_intake").on("click", function(event) {
    event.preventDefault(); // Prevent the form from submitting the traditional way

    var year = $("#year").val();
    var success_score = $("#success_score").val();
    var intake_status = $("#intake_status").val();
    var submission_deadline = $("#submission_deadline").val();

    // Check if any of the fields are empty
    if (year === "" || success_score === "" || intake_status === "" || submission_deadline === "") {
        Swal.fire({
            icon: 'warning',
