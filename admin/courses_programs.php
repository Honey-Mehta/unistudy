    ...
    if (mysqli_query($conn, $sqlDELETE)) {
        ...
        <body>
            <script>
                Swal.fire({
                    title: 'Deleted!',
                    text: ' Programs has been deleted.',
                    icon: 'success',
                    timer: 1000,
        ...
        <body>
            <script>
                Swal.fire({
                    title: 'Error!',
                    text: 'Failed to delete Programs.',
                    icon: 'error',
                    timer: 1000,
                    showConfirmButton: false
                }).then(function() {
   ...
   <?php include('sidebar.php'); ?>
    ...
    <!--  Search Bar -->
      ...
      <div class="container-fluid" style="margin-top:100px; ">
         ...
         <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" style="width:180px; height:50px; font-size:20px;"><i class="fa fa-plus mr-4" ></i> Programs </button>
           <div class="modal fade" id="myModal" >
                  ...
                  <form id="insertForm" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<div class="row">
									<div class="col-sm-12">
											<label for="name" style="float:left;">Select University:</label>
        ...
        ?>
										...
										<div class="col-sm-12">
                                        <label for="sel1" class="form-label">Program Name:</label>
                                       ...
                                       <input type="text" class="form-control" id="name" name="fee" required>
                                         ...
                                         <div class="col-sm-12">
                                        <label for="sel1" class="form-label">Tuition Per Year Approx:</label>
                                      	<input type="text" class="form-control" id="location" name="tution_per_year_approx" required>
										</div>
                                       
                                          <div class="col-sm-12">
                                        <label for="sel1" class="form-label">Application Fees:</label>
                                      	<input type="text" class="form-control" id="location_url"name="application_fees" required>
										</div>
    ...
    <table class="table">
        <thead>
            <tr >
                ...
                <th scope="col" style="min-width:150px;">Program</th>
                <th scope="col" style="min-width:150px;">Fee</th>
                   <th scope="col" style="min-width:150px;">Tuition Per Year Approx</th>
        ...
        <tbody>
         ...
         $records_per_page = isset($_GET['items_per_page']) ? (int)$_GET['items_per_page'] : 10; // Default to 10 if not set
            ...
            while($show=mysqli_fetch_assoc($sqllogistic)){
               ...
               $fetch_university=mysqli_fetch_assoc(mysqli_query($conn,"select * from `universities` where id='".$show['university_id']."'"));

            $id++;
            ?>
            <tr>
                <td scope="row"><?php echo $id;?></td>
                <td scope="row"><?php echo $fetch_university['name']; ?></td>
                   <td><?php echo $show['program'];?></td>
                <td><?php echo $show['fee'];?></td>
                  

    <td><?php echo $show['tuition_per_year_approx'];?></td>
